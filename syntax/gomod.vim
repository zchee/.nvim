" This file copied from https://github.com/fatih/vim-go/blob/4a429a0fc85c/syntax/gomod.vim
...
" " match toolchain versions
" syntax match gomodToolchainVersion "go1\.\d\+" contained
" highlight default link gomodGoVersion Identifier
