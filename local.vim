...
let g:deoplete#sources#clang#flags = ["-cc1", "-triple", "x86_64-apple-macosx10.9.0", "-Wdeprecated-objc-isa-usage", "-Werror=deprecated-objc-isa-usage", "-emit-obj", "-mrelax-all", "-disable-free", "-disable-llvm-verifier", "-main-file-name", "-", "-mrelocation-model", "pic", "-pic-level", "2", "-mthread-model", "posix", "-mdisable-fp-elim", "-masm-verbose", "-munwind-tables", "-target-cpu", "core2", "-target-linker-version", "262.4", "-v", "-dwarf-column-info", "-coverage-file", "-resource-dir", "/opt/apple/llvm/bin/../lib/clang/3.8.0", "-fdebug-compilation-dir", "/Users/zchee/.nvim", "-ferror-limit", "19", "-fmessage-length", "213", "-stack-protector", "1", "-fblocks", "-fobjc-runtime=macosx-10.9.0", "-fencode-extended-block-signature", "-fmax-type-align=16", "-fdiagnostics-show-option", "-fcolor-diagnostics", "-x", "c"]
