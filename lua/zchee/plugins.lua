  ...
  use {
    ...
    config = function()
      ...
      local tsserver = server.Server:new {
        ...
        default_options = {
          cmd_env = npm.env(servers.get_server_install_path("tsserver")),
        },
      }
      ...
      local yamlls =  server.Server:new {
        ...
        default_options = {
          cmd_env = npm.env(servers.get_server_install_path("yamlls")),
          settings = {
            yaml = {
              yamlVersion = "1.2",
              format = {
  ...
  use {
    ...
    config = function()
      ...
      parser_config.sql = {
        ...
        used_by = { "mysql" },
        install_info = {
          url = "~/src/github.com/DerekStride/tree-sitter-sql",
          branch = "fix-lock-resolved",
          files = { "src/parser.c" },
          generate_requires_npm = true,
          requires_generate_from_grammar = true,
        },
