...
"   " TODO(zchee): merge the all keywords
"   syn match   cgoKeywords             display contained "CFLAGS"
"   syn match   cgoKeywords             display contained "CPPFLAGS"
"   syn match   cgoKeywords             display contained "CXXFLAGS"
"   syn match   cgoKeywords             display contained "LDFLAGS"
"
...
"    \ start=/\v#cgo\s/
"    \ end="$"
"    \ contains=cgoHash,cgoSrcdir,cgoPkgConfig,cgoKeywords,cgoType,cgoOperator,cgoStructure,cgoStorageClass
"
"   " syn keyword cgoStatement	          goto break return continue asm
"   syn keyword cgoStatement	          asm
"
...
"   syn keyword	cgoType                 long short char void
...
"     syn keyword	cgoType               _Bool _Complex complex _Imaginary imaginary
...
"   syn keyword	cgoStructure            union enum typedef
"   " syn match   cgoStructure            display contained "struct"
"   syn keyword	cgoStorageClass         static register auto volatile extern
"   " syn match   cgoStorageClass         display contained "const"
...
"   endif
"   if exists('c_gnu')
"     " syn keyword	cgoStorageClass       inline
"     syn keyword	cgoStorageClass       __attribute__
"   endif
"   if !exists('c_no_c99')
"     " syn keyword	cgoStorageClass       inline
"     syn keyword	cgoStorageClass       restrict
"   endif
"   if !exists('c_no_c11')
...
"    \ contains=cgoStatement,cInclude,cgoKeywords,cgoType,cgoOperator,cgoStructure,cgoStorageClass,@CSource,goComment,cgoDirective
"
...
"   syn keyword	cType		long short char void
...
"     syn keyword	cType		_Bool _Complex complex _Imaginary imaginary
...
"   syn keyword	cStorageClass	keepend matchgroup=cgoComment static register auto volatile extern
"   if exists("c_gnu")
