...
neotree.setup({
  ...
  source_selector = {
    ...
    padding = { left = 2, right = 2 }, -- can be int or table. { left = 2, right = 0 },
    separator = { left = "▏", right = "▕" }, -- "▕", -- can be string or table, see below
  ...
  default_component_configs = {
    ...
    indent = {
      indent_size = 2,
      padding = 1,
      with_markers = true, -- indent guides
      indent_marker = "│",
      last_indent_marker = "└",
      highlight = "NeoTreeIndentMarker",
      with_expanders = nil, -- expander config, needed for nesting files. if nil and file nesting is enabled, will enable expanders
      expander_collapsed = "",
      expander_expanded = "",
    ...
    icon = {
      ...
      ---@param icon neotree.Render.Node
  ...
  filesystem = {
    ...
    --     if fby.gitignored and string.find(node.path, "vendor") then
  ...
  window = {                  -- see https://github.com/MunifTanjim/nui.nvim/tree/main/lua/nui/popup for possible options. These can also be functions that return these options.
    ...
    insert_as = "child", -- Affects how nodes get inserted into the tree during creation/pasting/moving of files if the node under the cursor is a directory: "child": Insert nodes as children of the directory under cursor. "sibling": Insert nodes  as siblings of the directory under cursor.
    mapping_options = {
      noremap = true,
      nowait = true,
    },
