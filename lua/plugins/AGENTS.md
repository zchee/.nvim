...
| `conform.lua` | Options table for stevearc/conform.nvim; none-ls formatting successor (stylua/rustfmt/yamlfmt/terraform_fmt/tombi + goimports-rereviser), manual format via <BS>f; pyproject 4-space via cwd hack |
