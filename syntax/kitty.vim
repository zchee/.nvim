...
syn keyword kittyAction contained
 ...
 \ kitty_shell last_used_layout launch layout_action load_config_file minimize_macos_window mouse_click_url mouse_click_url_or_select
 ...
 \ paste_selection_or_clipboard pop_keyboard_mode previous_tab previous_window push_keyboard_mode quit remote_control remote_control_script
 \ remove_marker reset_window_sizes resize_window save_as_session scroll_end scroll_home scroll_line_down scroll_line_up
 \ scroll_page_down scroll_page_up scroll_prompt_to_bottom scroll_prompt_to_top scroll_to_mark scroll_to_prompt second_window select_tab
 \ send_key send_text set_background_opacity set_colors set_tab_title set_window_title seventh_window show_error
 \ show_first_command_output_on_screen show_kitty_doc show_kitty_env_vars show_last_command_output show_last_non_empty_command_output show_last_visited_command_output show_scrollback signal_child
 \ simulate_color_scheme_preference_change sixth_window sleep start_resizing_window swap_with_window tenth_window third_window toggle_fullscreen
 \ toggle_layout toggle_macos_secure_keyboard_entry toggle_marker toggle_maximized toggle_tab ungrab_keyboard
