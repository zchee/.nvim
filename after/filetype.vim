...
augroup filetypedetect
  ...
  autocmd! BufRead,BufNewFile *.jsonschema                                      setlocal filetype=jsonschema
  autocmd! BufRead,BufNewFile *.mm                                              setlocal filetype=objcpp
  autocmd! BufRead,BufNewFile *.pbtxt                                           setlocal filetype=proto
  autocmd! BufRead,BufNewFile *.py[xd]                                          setlocal filetype=cython.pyrex
  autocmd! BufRead,BufNewFile *.replay                                          setlocal filetype=json
  autocmd! BufRead,BufNewFile *.S                                               setlocal filetype=gas  syntax=gas
